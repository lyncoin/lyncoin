...
{
    switch (unit) {
    case Unit::BTC: return QString("LCN");
    case Unit::mBTC: return QString("mLCN");
    case Unit::uBTC: return QString::fromUtf8("µLCM (bits)");
    case Unit::SAT: return QString("LCN sat");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Lyncoins");
    case Unit::mBTC: return QString("Milli-Lyncoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Lyncoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Lyncoin sat (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
