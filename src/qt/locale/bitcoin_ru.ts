...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Это ваши линкоин-адреса для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши линкоин-адреса для приема платежей. Используйте кнопку "Создать новый адрес получения" на вкладке получения, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Помните, что шифрование кошелька не может полностью защитить ваши линкоины от кражи вредоносным ПО, заразившим ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введите линкоин-адрес (например,%1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными линкоин-адресами</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Запросить платёж (генерирует QR-коды и URI протокола lyncoin:)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную линкоин-транзакцию (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную линкоин-транзакцию из буфера обмена</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n активное подключение к сети Lyncoin.</numerusform>
            <numerusform>%n активных подключения к сети Lyncoin.</numerusform>
            <numerusform>%n активных подключений к сети Lyncoin.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%1 загрузит и сохранит копию цепочки блоков Lyncoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неточной. Информация станет точной после завершения синхронизации с сетью линкоина. Прогресс синхронизации вы можете видеть снизу.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Открыть URI lyncoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Показать элементы управления частично подписанными линкоин-транзакциями (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически открыть порт линкоин-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция на нём включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически открыть порт линкоин-клиента на роутере. Сработает только если ваш роутер поддерживает NAT-PMP, и данная функция на нём включена. Внешний порт может быть случайным.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключиться к сети Lyncoin через SOCKS5 прокси.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключаться к сети Lyncoin через отдельный SOCKS5 прокси для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Lyncoin после подключения, и этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Не удаётся запустить обработчик click-to-pay для протокола lyncoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">"lyncoin://" — это неверный URI. Используйте вместо него "lyncoin:".</translation>
    </message>
    <message>
...
Если вы получили эту ошибку, вам следует попросить у продавца URI, совместимый с BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Не удалось обработать URI! Это может быть вызвано тем, что линкоин-адрес неверен или параметры URI сформированы неправильно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Внимание: это сообщение не будет отправлено вместе с платежом через сеть Lyncoin.</translation>
    </message>
    <message>
...
Примечание: комиссия рассчитывается пропорционально размеру в байтах. Так при комиссии "100 сатоши за kvB (виртуальный КБ)" для транзакции размером 500 виртуальных байт (половина 1 kvB) комиссия будет всего 50 сатоши.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Пожалуйста, проверьте черновик вашей транзакции. Будет создана частично подписанная линкоин-транзакция (PSBT), которую можно сохранить или скопировать, после чего подписать, например, офлайновым кошельком %1 или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Внимание: неверный линкоин-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Комиссия будет вычтена из отправляемой суммы. Получателю придёт меньше линкоинов, чем вы ввели в поле "Сумма". Если выбрано несколько получателей, комиссия распределится поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Сообщение, которое было прикреплено к URI. Оно будет сохранено вместе с транзакцией для вашего удобства. Обратите внимание: это сообщение не будет отправлено в сеть Lyncoin.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Вы можете подписывать сообщения/соглашения своими адресами, чтобы доказать, что вы можете получать линкоины на них. Будьте осторожны и не подписывайте непонятные или случайные сообщения, так как мошенники могут таким образом пытаться присвоить вашу личность. Подписывайте только такие сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подписать сообщение, чтобы доказать владение линкоин-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation type="unfinished">Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Проверить сообщение, чтобы убедиться, что оно действительно подписано указанным линкоин-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation type="unfinished">Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s испорчен. Попробуйте восстановить его с помощью инструмента lyncoin-wallet или из резервной копии.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка: версия дамп-файла не поддерживается. Эта версия линкоин-кошелька поддерживает только дамп-файлы версии 1. Обнаружен дамп-файл версии %s</translation>
    </message>
    <message>
