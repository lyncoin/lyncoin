...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 5053);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 5362);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 5362);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 5235);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 5259);
    }
    assert(false);
}
